...
If you are migrating older code from the upstream `flutter_slidable` package, you can refer to the original migration guide:
...
```yaml
dependencies:
  flutter_slidable_max: <latest_version>
```

In your library add the following import:

```dart
import 'package:flutter_slidable_max/flutter_slidable_max.dart';
```
...
For behavior inherited from the upstream `flutter_slidable` package, you can refer to the original FAQ:
https://github.com/letsar/flutter_slidable/wiki/FAQ
...
If you find a bug or want a feature, please use the issue and pull request workflow of the repository where you host this renamed package.

<!-- Links -->
[pub_badge]: https://img.shields.io/pub/v/flutter_slidable_max.svg
[pub]: https://pub.dev/packages/flutter_slidable_max
